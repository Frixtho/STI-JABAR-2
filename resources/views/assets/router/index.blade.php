@extends('layouts.app', ['title' => 'Manage Router — PLN Financial'])
    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="px-6 space-y-4">
            ...
            <nav class="flex items-center gap-1.5 text-sm">
                ...
                <span class="font-semibold text-gray-700 dark:text-gray-200">Manage Asset: Router</span>
            </nav>
            ...
            <div class="flex items-center justify-between flex-wrap gap-3">
                <div>
                    ...
                    <h1 class="text-xl font-bold text-pln-800 dark:text-white tracking-wide">Daftar Router</h1>
                </div>
                <div class="flex items-center gap-2">
                    <a href="{{ route('manage-router.import.form') }}" class="inline-flex items-center gap-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
                        </svg>
                        Import Data
                    </a>
                    <a href="{{ route('manage-router.create') }}" class="inline-flex items-center gap-2 bg-[#004A54] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#00363d] transition-colors">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
