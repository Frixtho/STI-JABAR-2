...
return new class extends Migration
{
    ...
    {
        Schema::create('server_storages', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('cpu_controller')->nullable();
            ...
            $table->string('app_standar_kamsiber')->nullable();
    ...
    {
        Schema::dropIfExists('server_storages');
    }
};