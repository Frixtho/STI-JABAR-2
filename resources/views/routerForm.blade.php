...
<main class="p-6 lg:p-10 space-y-5 w-full">
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-gray-400 dark:text-gray-500">
            {{ $router
                ? 'Perbarui informasi Router.'
                : 'Tambahkan informasi Router baru.'
            }}
        </p>
    </div>
        ...
        <div class="flex items-start gap-4 p-8 pb-6">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400 dark:text-gray-500">
                    Lengkapi informasi Router sesuai data yang ditampilkan pada tabel Manage Asset.
                </p>
            </div>
        ...
        <div class="border-t border-gray-100 dark:border-gray-700 p-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="ip_address_wan"
                        value="{{ old('ip_address_wan', $router->ip_address_wan ?? '') }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="baik"
                            @selected(old('status_kondisi', $router->status_kondisi ?? '') == 'baik')>
                            Baik
                        </option>

                        <option value="rusak"
                            @selected(old('status_kondisi', $router->status_kondisi ?? '') == 'rusak')>
                            Rusak
                        </option>

                        <option value="perlu_perbaikan"
                            @selected(old('status_kondisi', $router->status_kondisi ?? '') == 'perlu_perbaikan')>
                            Perlu Perbaikan
                        </option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="aktif"
                            @selected(old('status_operasional', $router->status_operasional ?? '') == 'aktif')>
                            Aktif
                        </option>

                        <option value="tidak_aktif"
                            @selected(old('status_operasional', $router->status_operasional ?? '') == 'tidak_aktif')>
                            Tidak Aktif
                        </option>
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="kritis"
                            @selected(old('tingkat_kritikalitas', $router->tingkat_kritikalitas ?? '') == 'kritis')>
                            Kritis
                        </option>

                        <option value="penting"
                            @selected(old('tingkat_kritikalitas', $router->tingkat_kritikalitas ?? '') == 'penting')>
                            Penting
                        </option>

                        <option value="normal"
                            @selected(old('tingkat_kritikalitas', $router->tingkat_kritikalitas ?? '') == 'normal')>
                            Normal
                        </option>
                    </select>
                </div>
            ...
            <div class="flex items-start gap-3 rounded-lg
                ...
                <p class="text-xs text-cyan-800 dark:text-cyan-300">
                    ...
                    informasi utama Router pada tabel Manage Asset.
                </p>
