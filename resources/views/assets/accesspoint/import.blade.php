@extends('layouts.app', ['title' => 'Import Asset Access Point — PLN Financial'])
    ...
    <div class="flex-1 min-w-0">
        ...
        <main class="p-6 lg:p-10 space-y-5 w-full">
            ...
            <nav class="flex items-center gap-1.5 text-sm">
                ...
                <span class="font-semibold text-gray-700 dark:text-gray-200">Import Asset Access Point</span>
            </nav>

            <h1 class="text-2xl font-bold text-pln-800 dark:text-white">Import Data Access Point dari Excel/CSV</h1>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
                ...
                <div class="flex items-start gap-4 p-8 pb-6">
                    ...
                    <div>
                        <h2 class="text-base font-bold text-pln-800 dark:text-white">Upload File Excel / CSV Access Point</h2>
                        <p class="text-sm text-gray-400 dark:text-gray-500">Unggah satu atau beberapa file data Access Point secara massal sekaligus.</p>
                    </div>
                </div>

                <div class="border-t border-gray-100 dark:border-gray-700 p-8 space-y-5">

                    <form action="{{ route('manage-asset.access-point.import') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-xs text-gray-400 mt-1">Tekan dan tahan tombol Ctrl (Windows) atau Cmd (Mac) di keyboard untuk memilih banyak file sekaligus sesuai template kolom Access Point (Atribut Umum & Spesifik).</p>
