...
return new class extends Migration
{
    ...
    {
        Schema::create('server_baremetals', function (Blueprint $table) {
            $table->id();
            ...
            // Atribut Spesifik Server Baremetal
            $table->string('hostname')->nullable();
            $table->string('merk'); // Wajib
            $table->string('model'); // Wajib
            ...
            $table->string('security_update_os')->nullable();
    ...
    {
        Schema::dropIfExists('server_baremetals');
    }
};