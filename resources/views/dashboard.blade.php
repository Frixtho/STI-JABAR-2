        ...
        <main class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="inline-flex items-center gap-1 text-xs font-medium text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 rounded-full px-2 py-0.5">
                    ...
                    <p class="mt-4 text-[11px] font-semibold tracking-wide text-gray-400 dark:text-gray-500 uppercase">Total Pendapatan</p>
                    <p class="mt-1 text-xl font-bold text-pln-800 dark:text-white">IDR 12.5T</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <p class="mt-4 text-[11px] font-semibold tracking-wide text-gray-400 dark:text-gray-500 uppercase">Pelanggan Aktif</p>
                    <p class="mt-1 text-xl font-bold text-pln-800 dark:text-white">2.4M</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        ...
                        <span class="inline-flex items-center gap-1 text-xs font-medium text-red-500 dark:text-red-400 bg-red-50 dark:bg-red-900/30 rounded-full px-2 py-0.5">
                            <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <p class="mt-4 text-[11px] font-semibold tracking-wide text-gray-400 dark:text-gray-500 uppercase">Konsumsi Daya</p>
                    <p class="mt-1 text-xl font-bold text-pln-800 dark:text-white">450 KWh</p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    ...
                    <p class="mt-4 text-[11px] font-semibold tracking-wide text-gray-400 dark:text-gray-500 uppercase">Tagihan Tertunda</p>
                    <p class="mt-1 text-xl font-bold text-red-600 dark:text-red-400">IDR 120M</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-4">
                ...
                <div class="xl:col-span-2 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    <div class="flex items-start justify-between">
                        <div>
                            <h2 class="text-sm font-bold text-pln-800 dark:text-white">Tren Pendapatan Bulanan</h2>
                            <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Laporan konsolidasi Q1 - Q3 2023</p>
                        </div>
                    ...
                    @php
                        $chart = [
                            ['label' => 'Januari', 'value' => 45, 'color' => 'bg-sky-100 dark:bg-sky-900/50'],
                            ['label' => 'Februari', 'value' => 65, 'color' => 'bg-sky-200 dark:bg-sky-800/60'],
                            ['label' => 'Maret', 'value' => 55, 'color' => 'bg-sky-200 dark:bg-sky-800/60'],
                            ['label' => 'April', 'value' => 80, 'color' => 'bg-sky-300 dark:bg-sky-700/70'],
                    ...
                    <div class="mt-8 flex items-end justify-between gap-4 h-48">
                        @foreach ($chart as $bar)
                            <div class="flex-1 flex flex-col items-center gap-2">
                                ...
                                <span class="text-[11px] text-gray-400 dark:text-gray-500">{{ $bar['label'] }}</span>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5">
                    <h2 class="text-sm font-bold text-pln-800 dark:text-white">Distribusi Pelanggan</h2>
                    ...
                    <div class="mt-6 flex items-center justify-center">
                        <div class="w-40 h-40 rounded-2xl border-[6px] border-pln-800 dark:border-accent-400 flex flex-col items-center justify-center">
                            <p class="text-xl font-bold text-pln-800 dark:text-white">2.4M</p>
                            <p class="text-[10px] tracking-wide text-gray-400 dark:text-gray-500 uppercase">Total Unit</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 space-y-3">
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="font-semibold text-gray-700 dark:text-gray-200">65%</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="flex items-center gap-2 text-gray-600 dark:text-gray-300">
                            ...
                            <span class="font-semibold text-gray-700 dark:text-gray-200">25%</span>
                        </div>
                        <div class="flex items-center justify-between text-sm">
                            <span class="flex items-center gap-2 text-gray-600 dark:text-gray-300">
                            ...
                            <span class="font-semibold text-gray-700 dark:text-gray-200">10%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700">
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-sm font-bold text-pln-800 dark:text-white">Transaksi Terbaru</h2>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                            @foreach ($transactions as $trx)
                                <tr>
                                    <td class="px-5 py-3.5 font-semibold text-pln-800 dark:text-white">{{ $trx['id'] }}</td>
                                    <td class="px-5 py-3.5 text-gray-700 dark:text-gray-300">{{ $trx['name'] }}</td>
                                    <td class="px-5 py-3.5 text-gray-500 dark:text-gray-400">{{ $trx['type'] }}</td>
                                    <td class="px-5 py-3.5">
                                        @if ($trx['status'] === 'BERHASIL')
                                            <span class="inline-flex text-[11px] font-semibold text-green-700 dark:text-green-400 bg-green-50 dark:bg-green-900/30 rounded-full px-2.5 py-1">BERHASIL</span>
                                        @else
                                            <span class="inline-flex text-[11px] font-semibold text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 rounded-full px-2.5 py-1">PENDING</span>
                                        @endif
                                    </td>
                                    <td class="px-5 py-3.5 text-right text-gray-700 dark:text-gray-300">{{ $trx['amount'] }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
