        ...
        <nav class="flex-1 px-4 space-y-1 mt-2">
            ...
            <a href="{{ route('settings') }}"
               class="flex items-center gap-3 px-3 py-2.5 rounded-md text-sm font-medium {{ request()->routeIs('settings*') ? 'bg-white/10 text-white' : 'text-pln-100 hover:bg-white/5' }}">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 0 1 0 .255c-.007.378.138.75１。43。99１l１。００５。８２８c。４２４。３５。５３４。９５５。２６ １。４３l-１。２９８ ２。２４７a１。１２５ １。１２５ 0 0 １ -１。３６９。４９１l-１。２１７-.４５６c-.３５５-.１３３-.７５-.０７２-１。０７６。１２４a６。５７ ６。５７ 0 0 １ -.２２。１２８c-.３３１。１８３-.５８１。４９５-.６４４。８６９l-.２１３ １。２８c-.０９。５４３-.５６。９４１-１。１１。９４１h-２。５９４c-.５５ 0-₁。₀₂-.₃₉₈-₁。₁₁-.₉₄l-.₂₁₃-₁。₂₈₁c-.₀₆₂-.₃₇₄-.₃₁₂-.₆₈₆-.₆₄₄-.₈７a６。₅₂ ６。₅₂ 0 ₀ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵗ ᵜ
                Settings
            </a>
        </nav>
